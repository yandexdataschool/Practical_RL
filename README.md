...
* Magical button that creates VM: https://beta.mybinder.org/v2/gh/yandexdataschool/Practical_RL/build_binder (may be down time to time. If it won't load for 2-3 minutes, it's down)
